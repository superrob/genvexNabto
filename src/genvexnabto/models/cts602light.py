...
class GenvexNabtoCTS602Light(GenvexNabtoBaseModel):
    def __init__(self, slaveDeviceModel):
        ...
        self._datapoints = {
            ...
            GenvexNabtoDatapointKey.FAN_LEVEL_SUPPLY: GenvexNabtoDatapoint(obj=0, address=98, divider=1, offset=0),
            GenvexNabtoDatapointKey.FAN_LEVEL_EXTRACT: GenvexNabtoDatapoint(obj=0, address=99, divider=1, offset=0),
